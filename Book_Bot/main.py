...
def books_get(message):
    ...
    # please wait message
    messageId = bot.reply_to(message , "⌛️📚 Please wait... Fetching book\n\nJust a moment while I fetch the book for you. Sit tight! 😊").message_id
