...
while True:
  ...
  for each_word in list_of_words:
    ...
    if each_word == "tired":
      ...
      encouragement_list.append("you will make it through ! remember to take a break when you need to")
      counter += 1
    ...
    if each_word == "lonely":
      ...
      encouragement_list.append("your friends are always ther for you!hou 'bout talking to them?")
      counter += 1 
